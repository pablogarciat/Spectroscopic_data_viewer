function  [Info] = VisualizeCellReal(Cell,Info)
...
if ~isfield(Info, 'ContrastFFT')
Info.ContrastFFT = [zeros(1,NumberOfImages); ones(1,NumberOfImages)];
end

if ~isfield(Info, 'ContrastReal')
Info.ContrastReal = [zeros(1,NumberOfImages); ones(1,NumberOfImages)];
end
